...
public class ExcelDataProvider extends DataProviderImpl {

	public final String beanUrl = "com.yeekent.selenium.bean.";
	...
	private void getCSVList(String beanName, String dataFile) throws Exception {
		...
		is = new FileInputStream(defaultPath + dataFile);
